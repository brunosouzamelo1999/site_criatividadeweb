...
const colorMap = {
  yellow: 'border-[#00adb5]/20 bg-[#00adb5]/10 text-[#00e5ff] shadow-[0_0_15px_rgba(0,173,181,0.15)] hover:border-[#00e5ff]/50',
  blue: 'border-[#00adb5]/20 bg-[#00adb5]/10 text-[#00e5ff] shadow-[0_0_15px_rgba(0,173,181,0.15)] hover:border-[#00e5ff]/50',
  green: 'border-accent-green/20 bg-accent-green/10 text-accent-green hover:border-accent-green/50',
  orange: 'border-[#00adb5]/20 bg-[#00adb5]/10 text-[#00e5ff] shadow-[0_0_15px_rgba(0,173,181,0.15)] hover:border-[#00e5ff]/50',
