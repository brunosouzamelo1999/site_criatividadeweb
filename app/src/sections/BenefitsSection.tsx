      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        <div ref={headlineRef} className="text-center opacity-0">
          ...
          <h2 className="font-heading text-3xl md:text-4xl lg:text-[48px] font-bold text-text-primary">
            Por que ter um <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00e5ff] to-[#00adb5] drop-shadow-[0_0_15px_rgba(0,229,255,0.25)]">site profissional</span>?
          </h2>
